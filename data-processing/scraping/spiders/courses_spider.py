...
Additionally, this file is also never run directly to scrape the website data (It will likely error if run directly).
The scrapy library has a number of shell commands that are used to scrape data. After using scrapy to autogenerate the
file __init__.py in  data-processing/scraping/spiders, the files __init__.py, items.py, middlewares.py, pipelines.py,
...
class CoursesSpider(scrapy.Spider):
    ...
    def parse(self, response) :
        ...
        Note: The function format was autogenerated by scrapy
